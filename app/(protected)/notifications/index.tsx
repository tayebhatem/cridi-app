    ...
    <View className="px-4">
      <CardLayout>
        <View className="flex flex-row items-center justify-between py-2 border-b border-neutral-100 dark:border-dark-300">
          <Text className="text-base text-neutral-500 font-kufi leading-9">
            {notifications.messagesNotifications}
          </Text>

          <Switch
            value={messagesNotification}
            onValueChange={() => setMessagesNotification(!messagesNotification)}
          />
        </View>
        <View className="flex flex-row items-center justify-between py-2 border-b border-neutral-100 dark:border-dark-300">
          <Text className="text-base text-neutral-500 font-kufi leading-9">
            {notifications.debtsNotifications}
          </Text>
          <Switch
            value={transactionsNotifications}
            onValueChange={() =>
              setTransactionsNotification(!transactionsNotifications)
            }
          />
        </View>
        <View className="flex flex-row items-center justify-between py-2 border-b border-neutral-100 dark:border-dark-300">
          <Text className="text-base text-neutral-500 font-kufi leading-9">
            {notifications.publicationsNotifications}
          </Text>
          <Switch
            value={adsNotifications}
            onValueChange={() => setAdsNotification(!adsNotifications)}
          />
        </View>
        <View className="flex flex-row items-center justify-between py-2">
          ...
          <Switch
            ...
            onValueChange={() => setRequestsNotification(!requestNotifications)}
          />
        </View>
      </CardLayout>
    </View>
