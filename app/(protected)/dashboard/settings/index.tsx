...
const SettingsScreen = () => {
  ...
  const { setUnreadNotificationsCount, setUnreadMessagesCount } =
            ...
            <View className="space-y-4">
              ...
              >
                <View className="flex flex-row items-center gap-x-3 w-full">
                  ...
                  <Text className="text-neutral-400 font-kufi-medium">
                    {settings.account}
                  </Text>
                </View>
                <MaterialIcons
          ...
          <CardLayout elevationAndroid={1}>
            <View className="space-y-4">
              ...
              >
                ...
                <Text className="text-red-500 font-kufi-semi-bold">
                  {settings.logout}
                </Text>
              </TouchableOpacity>
            </View>
