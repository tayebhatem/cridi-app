...
export const settingsTranslation = (language: LanguageType | null) => {
  return {
    ...
    logoutConfirmDesc:
      language?.id === "en"
        ? "Confirm if you want to logout now"
        : language?.id === "fr"
        ? "Confirmez si vous souhaitez vous déconnecter maintenant"
        : "تأكيد إذا كنت تريد تسجيل الخروج الآن",
  };
};
  ...
  return {
    accountTitle:
      language?.id === "en"
        ...
        : "الحساب",
    nameLabel:
      language?.id === "en" ? "Name" : language?.id === "fr" ? "Nom" : "الاسم",
    phoneLabel:
      language?.id === "en"
        ? "Phone"
        : language?.id === "fr"
    ...
    stateDescription:
      language?.id === "en"
        ...
        : language?.id === "fr"
        ? "Sélectionnez la wilaya actuelle"
        : "حدد الولاية الحالية",
    fieldLabel:
      language?.id === "en"
        ? "Field"
    ...
    fieldDescription:
      language?.id === "en"
        ? "Choose area of expertise or industry"
        : language?.id === "fr"
        ? "Choisissez le domaine d'expertise ou l'industrie"
        : "اختر مجال الخبرة أو الصناعة",
    descriptionLabel:
      language?.id === "en"
        ? "Description"
        : language?.id === "fr"
  ...
  return {
    ...
    passwordTooShort:
      language?.id === "en"
        ...
        : "يجب أن تتكون كلمة المرور 6 أحرف على الأقل",
    passwordMismatch:
      language?.id === "en"
